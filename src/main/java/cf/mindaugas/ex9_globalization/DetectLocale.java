	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(Locale aLocale : availableLocale){
	        ...
	        if(!aLocale.getScript().equals("")){
	           out.println("<p>Script Code: " + aLocale.getScript()+", Script Display Name: " +aLocale.getDisplayScript());
	        }
	        if(!aLocale.getVariant().equals("")){
	           out.println("<p>Variant Code: " + aLocale.getVariant()+", Variant Display Name: " +aLocale.getDisplayVariant());
	        }
	        out.println("<hr>");
		}
